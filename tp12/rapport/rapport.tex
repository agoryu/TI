...
% Set language to english
  ...
  Le transfert et le stockage d'image sont de plus en plus fréquent et nécessite de limiter la taille
  des fichiers. C'est pourquoi, lors de ce TP, nous allons voir comment est réalisé la compression 
  JPEG utilisé dans le format JPG.
  ...
  Nous pouvons voir que cette matrice ne permet pas encor de réduire l'information d'une image, car aucun des 
